...
function addTaskToTable(task) {
    ...
    const statuses = ["Em Recebimento","Recebido", "Conferência", "Aguardando Fiscal", "Aguardando Qualidade", "Aguardando Armazenagem", "Armazenado"];
...
function updateTaskInLocalStorage(updatedTask) {
    let tasks = JSON.parse(localStorage.getItem('tasks')) || [];
    tasks = tasks.map(task => task.codigo === updatedTask.codigo ? updatedTask : task);
    localStorage.setItem('tasks', JSON.stringify(tasks));
}
